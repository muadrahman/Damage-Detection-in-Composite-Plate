...
train_actual_horizontal, train_predicted_horizontal, test_actual_horizontal, test_predicted_horizontal = classify_svm(X, y_horizontal, "Model Horizontal Class")
train_actual_vertical, train_predicted_vertical, test_actual_vertical, test_predicted_vertical = classify_svm(X, y_vertical, "Model Vertical Class")
train_actual_box, train_predicted_box, test_actual_box, test_predicted_box = classify_svm(X, y_box, "Model Box Class")
...
excel_file_path = "D:/MTP/Second part ML project/combined_results_svm.xlsx"
...
random_20_rows = box_class_df.sample(n=20)
...
box1_numbers = box_class_df['Actual Box Class'].sample(n=20, random_state=1).tolist()
box2_numbers = box_class_df['Predicted Box Class'].sample(n=20, random_state=1).tolist()
...
# Add title
plt.title('Damage Plate classify as Horizontal Strips')
...
# Add title
plt.title('Damage Plate classify as  Vertical Strips')
